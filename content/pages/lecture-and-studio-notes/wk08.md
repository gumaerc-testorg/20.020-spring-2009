...
This challenge was inspired by the This American Life episode "{{% resource_link "a8cdfb08-a96c-4666-bd7c-1488916dfb01" "Mistakes Were Made" %}}." Chicago Public Radio, April 10, 2009.

Consider the content of "{{% resource_link "e942f160-0176-473c-a335-793af8399c67" "This is Just to Say" %}}," a poem by William Carlos Williams.

The poem is often taught in poetry classes and often spoofed. Consider, for instance, the spoofs by Kenneth Koch in "{{% resource_link "d943bf5b-0fd4-4c18-bd0e-6769dbb1c906" "Variations On A Theme By William Carlos Williams" %}}."

And one more spoof from the blog {{% resource_link "aeec0ebf-cb86-4ca5-a2e6-bfdd707ce99f" "Somewhere in the Suburbs" %}}.
...
The animation ends with a screen shot from the {{% resource_link "3617deb5-da17-4e37-b4d7-1d7462b63345" "BioBricks™ Foundation" %}}, a not-for-profit organization that "encourages the development and responsible use of technologies based on BioBrick standard DNA parts that encode basic biological functions." BioBricks represent one kind of standard biological parts, standardized to enable reliable physical composition.
...
The part numbers as well as the DNA itself are collected at the {{% resource_link "ef733537-db48-45f9-a342-348064a76b9f" "Registry of Standard Biological Parts" %}}.
...
First let's review one technical advance that opens a number of options for you, namely {{% resource_link "7a9461e6-d188-4e32-91a9-587a0bcf7cd1" "DNA synthesis" %}}. Then as a class we'll consider some options--weighing these (or others) in terms of their associated cost (both time and money).
...
This challenge is adapted from {{% resource_link "95361777-4fea-4944-b274-f022ddc61c6e" "Judy Loundagin's lesson" %}} for the Evolution and Nature of Science Institutes.
...
This challenge is adapted from one described at {{% resource_link "0ff86dfd-9e67-4b78-9c84-c383350ddc1e" "teachengineering.org" %}}. We will skip the preliminary descriptions of {{% resource_link "9cdb35fa-bbe5-4578-a7d9-a6f9ee388c32" "plate tectonics" %}} and just remind you of three stresses that give rise to deformation: compression, tension and shearing forces.
