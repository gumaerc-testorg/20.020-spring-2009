...
*   _"easier to do if there are simple steps."_
*   _"tried to illustrate cracking an egg, which has lots of steps and I'm not done"_
*   _"drew people gathering and building a building. Hard part was redrawing the same building each time."_
*   _"is the buoyancy inherent?" "would cells concentrate unless light present?"" would the system work with red light then blue light or do both need to be present at the same time?"_
...
*   _"it was hard...there wasn't enough time...we didn't know where to start...teamwork had to be figured out...being creative is hard...white boards helped...knowing a lot helps...to know things: ask others, research, copy existing ideas..."_
