...
Next you and your project team will generate a system overview for the {{% resource_link "f974b446-e4ab-49fb-89b5-00141b567e85" "Melbourne 2007 iGEM \"coliform\" project" %}}.
...
- As a class we'll watch the first 5 minutes of the Melbourne team's iGEM presentation. ({{% resource_link "545d1e95-b588-43dc-a981-551a20a0441d" "MPEG - 31.2MB" %}})
...
Let's try a more dynamic system. The {{% resource_link "bff02c11-cf5f-48d0-a98a-156e714ab7c4" "Polkadorks" %}} 2004 IAP iGEM team wanted their engineered cells to "form, diffuse, and form again in random areas on the plate. Our system should thus form time-varying patterns based on local random time-varying symmetry breaking." Check out the Polkadorks animation.
